...
class StopsSunPage extends StatefulWidget {
  final Future<FirebaseApp> _initialization = Firebase.initializeApp();
  @override
  _StopsSunPageState createState() => _StopsSunPageState();
}

class _StopsSunPageState extends State<StopsSunPage> {
  var linia;
  var kierunek;
  int godzina = 10;
  int minuta = 25;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                      ...
                      child: Scaffold(
                        body: StreamBuilder(
                            stream: FirebaseFirestore.instance.collection(
                                'Niedziele i swieta/' + linia['linia'].toString() + '/' + linia['kierunek'].toString() + '/p1/godziny').snapshots(),
      ...
      body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection(
              'Niedziele i swieta/' + linia['linia'].toString() + '/' + linia['kierunek'].toString() + '/k' + numerek.toString() + '/p'
          ).orderBy('l').snapshots(),
          builder: (context, snapshot) {
